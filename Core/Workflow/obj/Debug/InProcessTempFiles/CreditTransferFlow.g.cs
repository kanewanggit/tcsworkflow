...
namespace Workflow {
    ...
    public partial class CreditTransferFlow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(CreditTransferFlow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(CreditTransferFlow));
        ...
        private string FindResource() {
            string[] resources = typeof(CreditTransferFlow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".CreditTransferFlow.g.xaml") || resource.Equals("CreditTransferFlow.g.xaml"))) {
                    return resource;
                }
            }
